    ...
    DiscountContext dbContext, ILogger<DiscountService> logger) : DiscountProtoService.DiscountProtoServiceBase
{
    public override async Task<CouponModel> GetDiscount(GetDiscountRequest request, ServerCallContext context)
    {
        ...
        logger.LogInformation("Discount was succesfully retrieved for ProductName : {productName}, Amount : {amount}", coupon.ProductName, coupon.Amount);
    ...
    public override async Task<CouponModel> CreateDiscount(CreateDiscountRequest request, ServerCallContext context)
    {
        ...
        logger.LogInformation("Discount was succesfully created. ProductName: {ProductName}", coupon.ProductName);
